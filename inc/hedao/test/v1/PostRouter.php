...
use function hedao\lib\helper\getTokenFromBasicAuth;
...
class PostRouter extends BaseRouter{
  ...
  protected function init(){
    add_action( 'rest_api_init', function () {
      ...
      // ]);
      //更新一篇文章 (?P<id>\d+)
      register_rest_route( 'hedao/v1', '/post/update/(?P<id>\d+)', [
        'methods' => 'POST',
        'permission_callback' => [$this,'interceptIllegalRequest'],
      ...
      // ]);
      // //查询文章列表
      register_rest_route( 'hedao/v1', '/post/list', [
        'methods' => 'GET',
        'callback' => [$this,'queryListRouter']
      ]);
      //删除多篇文章
      register_rest_route( 'hedao/v1', '/post/delete', [
        'methods' => 'POST',
        'permission_callback' => [$this,'interceptIllegalRequest'],
