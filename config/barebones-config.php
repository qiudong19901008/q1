...
$args = array(
	...
	'menu_type'                 => 'menu', //menu代表单独页面选项, submenu则会把选项嵌入到外观中

	// Show the sections below the admin menu item or not.
	'allow_sub_menu'            => true, //允许则可以展开所有子选项

	'menu_title'                => esc_html__( 'Q1主题设置', 'your-textdomain-here' ), //菜单栏的文字
	...
	'admin_bar'                 => true, //顶部导航的菜单是否显示

	// Choose an icon for the admin bar menu.
	'admin_bar_icon'            => 'dashicons-portfolio', //顶部导航的菜单前的icon

	// Choose an priority for the admin bar menu.
	'admin_bar_priority'        => 50, //顶部导航的菜单的位置排序, 越小越靠前
	...
	'page_slug'                 => '_options', //该页面的slug

	// On load save the defaults to DB before user clicks save or not.
	'save_defaults'             => true, //自动保存
...
$section = array(
	'title'      => esc_html__( '多重选择', 'your-textdomain-here' ),
	'desc'       => esc_html__( '描述', 'your-textdomain-here' ),
	'id'         => 'opt-multi-subsection',
	// 'subsection' => true,
);

Redux::set_section( $opt_name, $section );

Redux::set_field( $opt_name, 'opt-multi-subsection', array(
	'id'=>'multi-text',
	'type' => 'multi_text',
	'title' => esc_html__('标题', 'your-textdomain-here'),
	'subtitle' => esc_html__('子标题', 'your-textdomain-here'),
	'desc' => esc_html__('描述', 'your-textdomain-here')
	),
) ;
