...
class QueryPostList extends BasePostDao{
  ...
  public function run(
    ...
    $args = $this->_addMetaQuery($orderBy,$orderByMetaKey,$metaNameList,$args);
    // var_dump($args);
    $query = new WP_Query($args);
    $res = $this->getNeededData($query,$includeTableNameList,$metaNameList);
    // if($this->_isOrderByMeta($orderBy,$orderByMetaKey,$metaNameList)){
  ...
  private function _addMetaQuery($orderBy,$orderByMetaKey,$metaNameList,$args){
    
    $isOrderByMeta = $this->_isOrderByMeta($orderBy,$orderByMetaKey,$metaNameList);
    if(!$isOrderByMeta){
      return $args; 
    }
  ...
  private function _isOrderByMeta($orderBy,$orderByMetaKey,$metaNameList){
